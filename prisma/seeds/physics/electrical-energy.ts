...
const QUESTIONS = [
  {
    questionText: "Lightning caused the wind to blow up the clouds, suggesting that electricity was generated by lightning.",
    options: [
  ...
  {
    questionText: "Reasons for using manganese wire in making standard resistors:",
    options: [
  ...
  {
    questionText: "A wire with resistance is stretched to double its length and bent into the shape of an equilateral triangle. The resulting resistance between the two vertices is",
    options: [
      { key: "1", text: "9/2 Ω" },
      { key: "2", text: "8/3 Ω" },
      { key: "3", text: "2 Ω" },
  ...
  {
    questionText: "Coulomb's law is incorrect in describing the electric force.",
    options: [
  ...
  {
    questionText: "Why do devices like TV and motors get damaged if the voltage drops when the power is constant?",
    options: [
  ...
  {
    questionText: "Which of the following is an incorrect statement about batteries?",
    options: [
      { key: "1", text: "In TV remotes, torch lights, and laser lights, batteries are connected in series." },
      { key: "2", text: "When batteries are connected in series, the resulting voltage increases." },
      { key: "3", text: "When batteries are connected in parallel, the resulting voltage is equal to the voltage of the battery with the maximum voltage." },
      { key: "4", text: "Parallel connection of batteries is used in inverter batteries." },
    ],
    correctOption: "4",
  },
  {
    ...
    options: [
      { key: "1", text: "When connecting copper wires, the copper coating on both ends of the copper wire should be removed" },
      { key: "2", text: "A circuit is made up of a cell, bulb, switch and wires" },
      { key: "3", text: "A diagram that shows an electrical circuit linearly is called a circuit diagram" },
      { key: "4", text: "Electricians and engineers connect circuits without using these circuit diagrams" },
    ],
    correctOption: "4",
  },
  {
    ...
    options: [
      ...
      { key: "2", text: "M.C.B switches itself off when the current in the circuit exceeds the safe level." },
      { key: "3", text: "M.C.B does not need to be changed frequently. But the fuse should be changed when it burns." },
  ...
  },
  {
    ...
    options: [
      { key: "1", text: "LED bulbs are used in TVs, laptops and mobile phones" },
      { key: "2", text: "The efficiency of light bulbs is indicated by star ratings" },
      { key: "3", text: "The lifespan of LED bulbs is longer than that of ordinary and CFL bulbs" },
      { key: "4", text: "Bulbs with more star ratings consume more electricity" },
    ],
    correctOption: "4",
  }
];

export async function seedElectricalEnergy(prisma: PrismaClient, subjectId: string, chapterId: string) {
