...
- `exam` (Purple/Indigo): **Use Sparingly.** Only for highly critical exam alerts (e.g., "This topic accounts for 2-3 questions every year in SSC CGL"). Do **not** use the `exam` variant for general lists of data.
